...
public class Bishop extends ChessPiece {
    ...
    public Bishop(Board board, Color color, ChessMatch match) {
        super(board, color, match);
    }

    @Override
    public String toString() {
        return ChessIconPieces.BISHOP.getIcon();
    }
    ...
    public boolean[][] possibleMoves() {
        ...
        mat = moves.AllDiagonalL(mat,getBoard(),position,this, 1);
        mat = moves.AllDiagonalL(mat,getBoard(),position,this, -1);
        mat = moves.AllDiagonalR(mat,getBoard(),position,this, 1);
        mat = moves.AllDiagonalR(mat,getBoard(),position,this, -1);
